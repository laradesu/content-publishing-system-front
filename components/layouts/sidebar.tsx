...
import IconMenuGallery from '@/components/icon/menu/icon-menu-gallery'
                ...
                <div className="h-full bg-white dark:bg-black">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            <img className="ml-[5px] w-8 flex-none" src="/assets/images/logo1.jpg" alt="logo" />
                            <span className="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">Agsa</span>
                        </Link>
                    ...
                    <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'dashboard' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('dashboard')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-secondary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('dashboard')}</span>
                                    </div>
                            ...
                            <h2 className="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                ...
                                <span className="text-secondary">{t('apps')}</span>
                            </h2>
                            ...
                            <li className="nav-item">
                                <ul>
                                    ...
                                    <li className="nav-item">
                                        <Link href="/apps/agsa/contacts" className="group">
                                            <div className="flex items-center">
                                                <IconMenuContacts className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('contacts')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    
                                    <li className="nav-item">
                                        <Link href="/apps/agsa/abouts" className="group">
                                            <div className="flex items-center">
                                                <IconMenuComponents className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('abouts')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                      {/* <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'general_assembly' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('invoice')}>
                                            <div className="flex items-center">
                                                <IconMenuInvoice className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('invoice')}</span>
                                            </div>

                                            <div className={currentMenu !== 'test' ? '-rotate-90 rtl:rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>

                                        <AnimateHeight duration={300} height={currentMenu === 'general_assembly' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/apps/invoice/list">{t('board_memebr')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/invoice/preview">{t('general_description')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>  */}
                                     <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'general_assembly' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('general_assembly')}>
                                            <div className="flex items-center">
                                                <IconMenuUsers className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('general_assembly')}</span>
                                            </div>

                                            <div className={currentMenu !== 'general_assembl' ? '-rotate-90 rtl:rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'general_assembly' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/apps/agsa/assembly/board_member">{t('board_memebr')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/agsa/assembly/general_assembly">{t('general_assembly')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                     <li className="nav-item">
                                        <Link href="/apps/agsa/sourceofFinance" className="group">
                                            <div className="flex items-center">
                                                <IconMenuCharts className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('source_of_finance')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                     <li className="nav-item">
                                        <Link href="/apps/agsa/membershipDevelopment" className="group">
                                            <div className="flex items-center">
                                                <IconMenuUsers className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('memeber_ship')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                     <li className="nav-item">
                                        <Link href="/apps/agsa/programManagement" className="group">
                                            <div className="flex items-center">
                                                <IconMenuUsers className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('program_management')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                     <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'project' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('project')}>
                                            <div className="flex items-center">
                                                <IconMenuTables className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('project')}</span>
                                            </div>

                                            <div className={currentMenu !== 'general_assembly' ? '-rotate-90 rtl:rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>

                                        <AnimateHeight duration={300} height={currentMenu === 'project' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/apps/agsa/project/education">{t('education')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/agsa/project/health">{t('health')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/agsa/project/livelihood">{t('livelihood')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                     <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'news' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('news')}>
                                            <div className="flex items-center">
                                                ...
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('news')}</span>
                                            </div>

                                            <div className={currentMenu !== 'news' ? '-rotate-90 rtl:rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'news' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/apps/agsa/new/new">{t('newsandevent')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/agsa/new/bid">{t('bid')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/agsa/new/magazine">{t('magazine')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/agsa/new/vacancy">{t('vacancy')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                     <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'get_envolved' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('get_envolved')}>
                                            <div className="flex items-center">
                                                <IconMenuForms className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('get_envolved')}</span>
                                            </div>

                                            <div className={currentMenu !== 'get_envolved' ? '-rotate-90 rtl:rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>

                                        <AnimateHeight duration={300} height={currentMenu === 'get_envolved' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/apps/agsa/getInvolved/donate">{t('donate')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/agsa/getInvolved/member">{t('member')}</Link>
                                                </li>
                                                 <li>
                                                    <Link href="/apps/agsa/getInvolved/volunteer">{t('volunteer')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                     <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'documents' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('documents')}>
                                            <div className="flex items-center">
                                                <IconMenuDocumentation className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('documents')}</span>
                                            </div>

                                            <div className={currentMenu !== 'documents' ? '-rotate-90 rtl:rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>

                                        <AnimateHeight duration={300} height={currentMenu === 'documents' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/apps/agsa/document/report">{t('report')}</Link>
                                                </li>
                                                
                                                 <li>
                                                    <Link href="/apps/agsa/document/plan">{t('plan')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/agsa/document/shortbrief">{t('shortbrief')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/agsa/document/longbrief">{t('longbrief')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                        <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'gallery' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('gallery')}>
                                            <div className="flex items-center">
                                                <IconMenuGallery className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#007BFF] dark:group-hover:text-white-dark">{t('gallery')}</span>
                                            </div>

                                            <div className={currentMenu !== 'gallery' ? '-rotate-90 rtl:rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>

                                        <AnimateHeight duration={300} height={currentMenu === 'gallery' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/apps/agsa/gallery/photo">{t('photo')}</Link>
                                                </li>
                                                <li>
                                                    <Link href="/apps/agsa/gallery/video">{t('video')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                    ...
                                    <li className="nav-item">
                                        <Link href="/apps/agsa/hero" className="group">
                                            <div className="flex items-center">
                                                <IconMenuMailbox className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('hero')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    
                                    <li className="nav-item">
                                        <Link href="/apps/agsa/testimonial" className="group">
                                            <div className="flex items-center">
                                                <IconMenuUsers className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('testimoniry')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                     <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'comments' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('comments')}>
                                            <div className="flex items-center">
                                                <IconMenuDocumentation className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('comment')}</span>
                                            </div>

                                            <div className={currentMenu !== 'comments' ? '-rotate-90 rtl:rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>

                                        <AnimateHeight duration={300} height={currentMenu === 'comments' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/apps/agsa/comment">{t('comment')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                     <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'media' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('media')}>
                                            <div className="flex items-center">
                                                <IconMenuDocumentation className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('media')}</span>
                                            </div>

                                            <div className={currentMenu !== 'media' ? '-rotate-90 rtl:rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>

                                        <AnimateHeight duration={300} height={currentMenu === 'media' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/apps/agsa/media">{t('media')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                      <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'company' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('company')}>
                                            <div className="flex items-center">
                                                <IconMenuDocumentation className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('company')}</span>
                                            </div>

                                            <div className={currentMenu !== 'company' ? '-rotate-90 rtl:rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'company' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/apps/agsa/company">{t('company')}</Link>
                                                </li>
                                                 <li>
                                                    <Link href="/apps/agsa/map">{t('map')}</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                            ...
                            <h2 className="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                <IconMinus className="hidden h-5 w-4 flex-none" />
                                <span className="text-secondary">{t('user_and_pages')}</span>
                            </h2>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'users' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('users')}>
                                    <div className="flex items-center">
                                        <IconMenuUsers className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-primary ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('users')}</span>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'users' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href="/apps/agsa/user/register">{t('users_list')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/apps/agsa/user/profile">{t('profile')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/apps/agsa/user/user-account-settings">{t('account_settings')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
