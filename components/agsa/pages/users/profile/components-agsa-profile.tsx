'use client';
import { useGetAllUser, useGetUserById } from '@/components/hooks/useUser';
...
import { GetUserByIdResponse, User } from '@/components/types/user';
...
const ComponentsAgsaProfile = () => {
    ...
    const { data, isLoading, error } = useGetUserById(userId as number);
                    ...
                    <div className="panel">
                        ...
                        <div className="mb-5">
                            ...
                            <div className="flex flex-col items-center justify-center">
                                ...
                                <p className="text-xl font-semibold text-primary">{user?.fullName}</p>
                            </div>
                            <ul className="m-auto mt-5 flex max-w-[160px] flex-col space-y-4 font-semibold text-white-dark">
                                <li className="flex items-center gap-2">
                                    <IconCoffee className="shrink-0" /> {user?.title}
                                </li>
                                <li className="flex items-center gap-2">
...
export default ComponentsAgsaProfile;
